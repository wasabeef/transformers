...
extra.apply {
  ...
  set("artifact", "picasso-gpu")
  set("libraryDescription", "An Android transformation library providing a variety of image transformations for Picasso.")
